...
/**
 * Base interface for Validator sub-classes that validate form fields according to
 * their logic implemented in process()
 *
 */
interface Validator {
    /**
     * @return error message if the field is invalid or null if everything is ok
     *
     */
    fun process(view: View): String?
}